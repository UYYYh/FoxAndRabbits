...
namespace PredatorPrey
{
    ...
    class Location
    {
        ...
        public Location(string terrain)
        {
            Fox = null;
            Warren = null;
            Terrain = terrain;
    ...
    class Simulation
    {
        ...
        private int InputCoordinate(char Coordinatename)
        {
            ...
            {               
                if (Count != 0)
                {
                    Console.WriteLine("Coordinate is outsidde of landscape, please try again.");
                }
            ...
            for (int FoxX = 0; FoxX < LandscapeSize; FoxX++)
            {
                for (int FoxY = 0; FoxY < LandscapeSize; FoxY++)
                {
                    if (Landscape[FoxX, FoxY].Fox != null)
                    {
                        ...
                        if (CheckIfPathCrossesRiver(FoxX, FoxY, WarrenX, WarrenY))
                        {
                            PercentToEat = 0;
                        }
...
#
    class Rabbit : Animal
    {
        ...
        public override void CalculateNewAge()
        {
            ...
            {
                ProbabilityOfDeathOtherCauses = ProbabilityOfDeathOtherCauses * 1.50;
            }
